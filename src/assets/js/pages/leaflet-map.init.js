...
const MAPBOX_TILE_URL = `https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=${MAPBOX_TOKEN}`;
...
createMapboxLayer('mapbox/streets-v11').addTo(mymap);

// leaflet-map-marker
var markermap = L.map('leaflet-map-marker').setView([51.505, -0.09], 13);
createMapboxLayer('mapbox/streets-v11').addTo(markermap);
...
createMapboxLayer('mapbox/streets-v11').addTo(popupmap);
...
createMapboxLayer('mapbox/light-v9').addTo(interactivemap);
...
var grayscale = L.tileLayer(MAPBOX_TILE_URL, {
  id: 'mapbox/light-v9',
  tileSize: 512,
  zoomOffset: -1,
  attribution: MAPBOX_ATTRIBUTION
...
var streets = L.tileLayer(MAPBOX_TILE_URL, {
